...
export default function Vehicules() {
  ...
  return (
      <div className="p-6 bg-white rounded shadow">
        ...
        <form onSubmit={ajouterOuModifierVehicule} className="mb-6 flex flex-wrap gap-4 items-end">
          <input
              placeholder="Plaque"
              value={plaque}
          ...
          <button
              ...
              } text-white font-medium px-4 py-2 rounded-md shadow`}
          >
        ...
        <table className="min-w-full bg-gray-50 border border-gray-200">
          ...
          {vehicules.map(v => (
              <tr key={v.id}>
                <td className="border px-4 py-2">{v.plaque}</td>
